...
std::vector<at::Tensor> rasterize(
        at::Tensor face_vertices,
        at::Tensor depth_buffer,
        at::Tensor triangle_buffer,
        at::Tensor baryw_buffer,
...
std::vector<at::Tensor> rasterize_colors(
        at::Tensor face_vertices,
        at::Tensor face_colors,
        at::Tensor depth_buffer,
        at::Tensor triangle_buffer,
...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
    m.def("rasterize", &rasterize, "RASTERIZE (CUDA)");
    m.def("rasterize_colors", &rasterize_colors, "RASTERIZE COLORS (CUDA)");
}
